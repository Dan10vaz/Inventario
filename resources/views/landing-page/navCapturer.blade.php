				...
				<div class="flex justify-between">
					<div class="flex space-x-7">
						...
						<div class="hidden md:flex items-center space-x-1">
							...
							<a href="{{route('index')}}" class="py-4 px-2 text-gray-500 font-semibold hover:text-green-500 transition duration-300">Registro</a>
							<a href="{{route('index')}}" class="py-4 px-2 text-gray-500 font-semibold hover:text-green-500 transition duration-300">Mis datos</a>
						</div>
					</div>
					<!-- Secondary Navbar items -->
					<div class="hidden md:flex items-center space-x-3 ">
						<a href="" class="py-2 px-5 font-medium text-white bg-green-500 rounded-lg hover:bg-green-700 transition duration-300">Cerrar Sesion</a>
					</div>
					<!-- Mobile menu button -->
