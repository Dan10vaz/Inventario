            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 mt-5">
                ...
                <div class="bg-white py-8 px-4 shadow-xl rounded-lg mt-10 lg:mt-0 m-5 md:m-40 lg:m-0">
                    ...
                    <div class="flex items-center justify-between pb-5">
                        <a href="./login" class="text-gray-500 text-sm hover:text-green-400">Ya tienes cuenta? Inicia
                            Sesión</a>
                        <a href="./forget-password" class="text-gray-500 text-sm hover:text-green-400">Olvide mi
                            password</a>
                    </div>
